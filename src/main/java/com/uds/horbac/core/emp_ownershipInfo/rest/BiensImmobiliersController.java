...
import com.uds.horbac.core.emp_ownershipInfo.dto.BiensImmobiliersDTO;
import com.uds.horbac.core.emp_ownershipInfo.entities.BiensImmobiliers;
import com.uds.horbac.core.emp_ownershipInfo.service.BiensImmobiliersService;
...
public class BiensImmobiliersController {
	...
	@ResponseStatus(value=HttpStatus.OK)
	public BiensImmobiliersDTO createBiensImmobiliers(@RequestBody BiensImmobiliersDTO biensImmobiliersDTO ) {
	...
	@ResponseStatus(value=HttpStatus.OK)
	public BiensImmobiliersDTO updateBiensImmobiliers(@RequestBody BiensImmobiliersDTO biensImmobiliersDTO ) {
		BiensImmobiliers biensImmobiliers = modelMapper.map(biensImmobiliersDTO, BiensImmobiliers.class);
		return modelMapper.map(biensImmobiliersService.save(biensImmobiliers), BiensImmobiliersDTO.class);
	}
